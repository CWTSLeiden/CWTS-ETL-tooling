...
call %powershell_exe% "& %functions_folder%\validate_data_types_compare\validate_data_types_compare.ps1 -new %new_validation_file% -old %old_validation_file% -out view"
